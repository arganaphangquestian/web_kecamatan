<x-modal>
  <x-slot name="title">Tambah Staff</x-slot>
  <x-slot name="content">
    <div class="flex flex-col">
      ...
      <label class="flex flex-col mb-4">
        ...
        <input type="password" placeholder="********" class="bg-transparent border-gray-200 rounded-md" wire:model="user.password"/>
      </label>
      <div class="flex flex-col gap-4">
        <button type="button" wire:click="submit" class="px-4 py-2 rounded-md bg-green-200 hover:bg-green-300 text-green-800">Save</button>
